    ...
    try:
        ...
        if orchestrator == 'kubernetes':
            ...
            for container in containers:
                test_net_config = low_level_client.inspect_container(container.id)['NetworkSettings']['Networks'].get(
                    'test_overlay')
    ...
    while True:
        try:
            ...
            for pod in need_pods.items:
                ...
                if container_id in local_containers and container_id not in already_bootstrapped and \
                    ...
                    try:
                        ...
                        if "dashboard" in pod.metadata.name:
                            try:
                                ...
                                cmd = ["nsenter", "-t", str(container_pid), "-n", "/usr/bin/python3",
                                       "/usr/bin/NEEDDashboard", TOPOLOGY]
